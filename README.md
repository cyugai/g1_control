# G1 Control
This repo is built based on https://github.com/botianhao/humanoid_control using g1_12dofs file.

It's not perfect, welcome to open issues for discussion.
## Build and Start

### OCS2 on ROS2

This project is running on Ubuntu 22. Before starting this project, you should complete the installation of ROS2. 
For the installation of ROS2, please refer to the official website of ROS2.

For the installation of OCS2 on ROS2, please refer to the link: https://github.com/legubiao/ocs2_ros2




1. OCS2 on ROS2 is a very large project. To run this project, it's not necessary to compile everything. 
   If you can smoothly run the case "legged", that will be sufficient for this project.
   ```bash
...
```bash
colcon build --packages-up-to g1_mujoco_sim
colcon build --packages-up-to g1_controllers
colcon build --packages-up-to g1_legged_description
# To start simulation with the cheat state estimator.
# Press P to start the output of the humanoid controller and press SPACE on mujoco simulation window and input the gait command. 
ros2 launch g1_controllers load_cheat_controller.launch.py
```



This g1 controller is based on the code of pocketxjl's ROS1 version : https://github.com/pocketxjl/humanoid-control?tab=readme-ov-file
Due to time constraints, many of the function names still follow the conventions used in ROS1 and do not comply with the standards of ROS2. 
...
## Acknowledgement
[legged-control by botianhao](https://github.com/botianhao/humanoid_control): bipedal robot control in ros2 with ocs2
